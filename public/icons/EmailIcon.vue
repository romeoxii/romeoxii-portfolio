<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 48 48">
    <path
      ...
      opacity="0.15"
    ></path>
    <path fill="#fff" d="M2.48 10.94h42.67v26.12H2.48Z"></path>
    <path
      fill="#f0f0f0"
      d="M44 34.37H3.58a1.1 1.1 0 0 1-1.1-1.1V36a1.1 1.1 0 0 0 1.1 1.1H44a1.1 1.1 0 0 0 1.1-1.1v-2.73a1.1 1.1 0 0 1-1.1 1.1"
    ></path>
    <path
      fill="none"
      stroke="#51a2ff"
